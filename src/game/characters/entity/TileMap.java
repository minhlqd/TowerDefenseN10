...
public class TileMap extends ImageView{
    private final static String TILESET_64 = "game/characters/res/tileset/tile-641_11.jpg";
    private final static String TEXT = "C:\\Users\\E7470\\IdeaProjects\\TowerDefense\\src\\game\\characters\\res\\text\\map";
    ...
    public ArrayList<Coordinate> getPath(){
        ...
        for (int i = 0; i < path.size(); i++){
            System.out.print(path.get(i).getTileY() + " " + path.get(i).getTileX());
            System.out.println();
        }
        return path;
    }
